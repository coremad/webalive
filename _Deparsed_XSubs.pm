...
package Net::LibIDN2 {
sub idn2_check_version(;$) ;
sub idn2_lookup_u8($;$$) ;
sub idn2_lookup_ul($;$$) ;
sub idn2_register_u8($;$$$) ;
sub idn2_register_ul($;$$$) ;
sub idn2_strerror($) ;
sub idn2_strerror_name($) ;
sub idn2_to_ascii_8($;$$) ;
sub idn2_to_ascii_l($;$$) ;
sub idn2_to_unicode_88($;$$) ;
sub idn2_to_unicode_8l($;$$) ;
sub idn2_to_unicode_ll($;$$) ;
sub idn2_to_unicode_u8($;$$) ;
sub idn2_to_unicode_ul($;$$) ;
}
package Net::SSLeay {
sub AF_802() ;
sub AF_AAL() ;
